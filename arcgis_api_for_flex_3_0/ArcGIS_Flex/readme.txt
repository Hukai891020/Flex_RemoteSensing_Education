...
3. In Adobe Flash Builder, add the API Library to the project through Project -> Properties -> Flex Build Path -> Library Path -> Add SWC (and locate the "agslib-3.0-2012-06-06.swc")
...
More Information
================
For more information go to http://help.arcgis.com/en/webapi/flex/

License agreement at http://www.esri.com/legal/pdfs/mla_e204_e300/english.pdf.
