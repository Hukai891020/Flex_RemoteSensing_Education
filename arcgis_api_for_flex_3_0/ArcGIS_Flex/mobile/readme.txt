This folder contains several Flex Mobile projects using the ArcGIS API for Flex.
...
3. Add the API Library to the project through Project -> Properties -> Flex Build Path -> Library Path -> Add SWC (and locate the "agslib-3.0-2012-06-06.swc").
